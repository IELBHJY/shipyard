...
public class Genetic {
    ...
    * */
    ...
    public void creatInitialSolution(){
    ...
    private void decoding(int[] task, int[] truck, HashMap<Integer,List<Integer>> solution){
        for(int k=1;k<=this.truck;k++){
            solution.put(k,new ArrayList<Integer>());
        }
    ...
    private void crossover(int first,int second,int p1,int p2){
        ...
        List<Integer> truck1=new ArrayList<Integer>();
        ...
        List<Integer> task2=new ArrayList<Integer>();
        List<Integer> truck2=new ArrayList<Integer>();
        for(int i=position+1;i<=task;i++){
    ...
    public void showSolution(){
        ...
        for(int t=1;t<=truck;t++){
            result.put(t,new ArrayList<Integer>());
        }
        for(int i=1;i<=task;i++){
            result.get(parent_trucks[0][i]).add(parent_tasks[0][i]);
            results.put(i,parent_trucks[0][i]);
        }
    }
    ...
    public HashMap<Integer,List<Integer>> getResult(){
        return this.result;
    }
